          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td></td>
                <td></td>
                <td><input type="text" readOnly value={totalAmount} /></td>
              </tr>
              <tr>
                <td></td>
                <td>CGST (1.5%)</td>
                ...
                <td></td>
                <td></td>
                <td><input type="text" readOnly value={cgst} /></td>
              </tr>
              <tr>
                <td></td>
                <td>SGST (1.5%)</td>
                ...
                <td></td>
                <td></td>
                <td><input type="text" readOnly value={sgst} /></td>
              </tr>
              <tr>
                <td></td>
                <td>Final amount</td>
                ...
                <td></td>
                <td></td>
                <td><input type="text" readOnly value={finalAmount} /></td>
              </tr>
            </tbody>
          </table>
        </div>
